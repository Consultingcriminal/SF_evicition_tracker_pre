...
class stag_layer:
    ...
    def execute_query(self,query):
        try:
            ...
            if self.schema_status == False:
                self.create_raw =  "CREATE SCHEMA sf_staging"
    ...
    def dim_location(self):
        ...
        query = """
        CREATE TABLE sf_staging.dim_location (
    ...
    def mod_reason(self):
        ...
        query = """
        CREATE TABLE sf_staging.dim_mod_reason (
    ...
    def dim_date(self):
        query = """
        CREATE TABLE sf_staging.dim_date (
    ...
    def dim_district(self):
        ## Indexing Left
        query = """
        CREATE TABLE sf_staging.dim_district (
    ...
    def dim_neighborhood(self):
        ## Indexing Left
        query = """ 
        CREATE TABLE sf_staging.dim_neighborhood (
    ...
    def fact_eviction(self):
        query = """
        CREATE TABLE sf_staging.fact_evictions (
...
if __name__ == '__main__':
    ...
    sl = stag_layer(schema_status = False)    
    sl.dim_location()
    sl.dim_date()
    sl.dim_district()
    sl.dim_neighborhood()
